...
function draw() {
  ...
  if (!gameOver && !victory) {
    ...
    drawEndScreen(" Parabéns, você concluiu! 🎉");
  } else if (gameOver) {
...
function drawStartScreen() {
  ...
  fill(0);
  textSize(32);
  text("🍓 Jogo Da Colheita 🍓", width / 2, height / 2 - 40);
  textSize(20);
...
function drawInstructionsScreen() {
  ...
  fill(0);
  textSize(28);
  text("🍓 Colete 40 Morangos antes do tempo finalizar!", width / 2, height / 2 - 20);
  textSize(18);
  text("Pressione a tecla ESPAÇO para começar!", width / 2, height / 2 + 20);
}
